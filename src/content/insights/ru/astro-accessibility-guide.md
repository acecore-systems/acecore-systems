...
checklist:
  title: Улучшения доступности на тот момент
  items:
...
**Обновление от 26 сентября 2026 года:** Код и оценка PageSpeed Accessibility 100 ниже относятся к сайту Astro + UnoCSS в марте 2026 года. В текущем сайте компании указан Tailwind CSS 4.3.3. Эти отдельные проверки и автоматическая оценка не доказывают соответствие всего сайта WCAG AA. Для оценки нужно определить страницы и полные процессы, затем проверить все критерии уровней A и AA автоматическими и ручными методами ([требования W3C](https://www.w3.org/WAI/WCAG22/Understanding/conformance)).
