...
callout:
  ...
  text: "Описание оптимизаций CSS, шрифтов, изображений и рекламы, проверенных на Astro и UnoCSS в июле 2026 года. Перед применением проверьте текущую реализацию и условия измерения."
processFigure:
...
> **Дополнение от 26 сентября 2026 года:** Если не указано иное, слово «текущий» ниже означает 29 июля 2026 года. [Текущие зависимости](https://github.com/acecore-systems/acecore-net/blob/main/package.json) используют Astro ^7.3.3 и Tailwind CSS 4.3.3. Не считайте старые настройки UnoCSS и условия доставки актуальной инструкцией без проверки реализации. Решения принимайте по фактическому результату и сопоставимым измерениям.
