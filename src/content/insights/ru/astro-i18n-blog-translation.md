...
faq:
  ...
  items:
    ...
    - question: Как обеспечивается качество перевода?
      answer: "Мы используем AI-перевод через GitHub Copilot. Сначала создаётся английская версия как промежуточный язык, затем переводится с английского на каждый целевой язык для снижения разброса качества. Значения тегов во frontmatter остаются на японском, URL, блоки кода и пути к изображениям не изменяются. Так работали в июле 2026 года. Сейчас для создания переводов используют OpenAI Batch."
...
> **Дополнение от 26 сентября 2026 года:** Astro 7.1.3, UnoCSS, количество статей и перевод с Copilot ниже относятся к июлю 2026 года. [Текущие зависимости](https://github.com/acecore-systems/acecore-net/blob/main/package.json) используют Astro ^7.3.3 и Tailwind CSS 4.3.3; [обновление процесса перевода](/insights/copilot-translation-pipeline/) описывает OpenAI Batch. Прежде чем считать примеры и числа актуальными, проверьте исходный код и опубликованные страницы.

## Реализация по состоянию на июль 2026 года
