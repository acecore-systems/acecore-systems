...
faq:
  ...
  items:
    - question: Можно ли использовать GitHub Copilot Agent Mode бесплатно?
      answer: "Да, Copilot Free доступен. В сентябре 2026 года объём использования зависит от плана, модели и AI Credits; задачи агента могут вызывать модель несколько раз."
...
> **Обновление за сентябрь 2026 года:** Использование Copilot теперь описывается через AI Credits, а не через упомянутое в исходной статье месячное число запросов Agent Mode. Сверяйтесь с [актуальной документацией GitHub](https://docs.github.com/en/copilot/concepts/billing-and-usage/individuals/billing).
