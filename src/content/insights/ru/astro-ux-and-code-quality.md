...
callout:
  ...
  text: "В Astro ClientRouter собранные модульные скрипты обычно выполняются только один раз, а встроенные скрипты могут запускаться повторно в зависимости от навигации. Для повторной инициализации используйте события жизненного цикла."
processFigure:
...
Согласно актуальной документации Astro, `z` для схем контента импортируется из `astro/zod`. См. [руководство по коллекциям контента](https://docs.astro.build/en/guides/content-collections/).
