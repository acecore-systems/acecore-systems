...
**Дополнение от 26 сентября 2026 года:** 100 баллов относятся к измерению PageSpeed Insights от 29 марта 2026 года. Это не гарантия текущего результата или опыта каждого реального пользователя. См. [документацию Google](https://developers.google.com/speed/docs/insights/v5/about) о лабораторных и полевых данных и колебаниях.
