...
faq:
  ...
  items:
    ...
    - question: Следует ли всё создавать только на Cloudflare?
      answer: "Нет. Некоторые части, например ИИ-консультант, используют OpenAI API. Важно сосредоточить в Cloudflare доставку, границу API, базу данных и защиту от ботов, осознанно разделив места с внешними сервисами и без них."
