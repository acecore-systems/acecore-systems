...
> **Дополнение от 26 сентября 2026 года:** Цены, шаги в панели управления и значения DNS относятся к описанному переносу. Не копируйте их для другого домена без проверки актуальных сведений [KAGOYA MAIL](https://www.kagoya.jp/mail/) и [Zoho Workplace](https://www.zoho.com/jp/workplace/pricing.html), своего договора и значений аутентификации для своего домена.
