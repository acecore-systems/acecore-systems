...
faq:
  ...
  items:
    - question: Можно ли получить 100 баллов в PageSpeed Insights на мобильных?
      answer: "Да. Здесь зафиксированы 99 баллов на мобильных устройствах 25 марта 2026 года, а [повторный замер 29 марта](/insights/website-improvement-final-batch/) показал 100. Ни один из результатов не гарантирует сегодняшнюю оценку."
...
**Дополнение от 26 сентября 2026 года:** Эта статья фиксирует улучшения на 25 марта 2026 года. Тогда 99 баллов считались практическим пределом, но [повторный замер 29 марта](/insights/website-improvement-final-batch/) показал 100. Это результаты отдельных измерений, а не текущие оценки. [Документация Google](https://developers.google.com/speed/docs/insights/v5/about) объясняет колебания.
