...
import guide from "../../../src/data/guide.json" with { type: "json" };
import home from "../../../src/data/home.json" with { type: "json" };
import itAdvisor from "../../../src/data/it-advisor.json" with { type: "json" };
import pricing from "../../../src/data/pricing.json" with { type: "json" };
...
import operations from "../../../src/data/service-details/operations.json" with { type: "json" };
import siteFunctions from "../../../src/data/service-details/site-functions.json" with { type: "json" };
